...
type FilterType = "all" | "short-term" | "long-term" | "almost-funded";
...
const InvestPage: React.FC<InvestPageProps> = ({ onShowDetails }) => {
  ...
  const investmentOpportunities = useMemo(() => {
    ...
    switch (activeFilter) {
      case "short-term":
        // Short term: Properties to be sold (houses, rentals, land without projects)
        return opportunities.filter(
          (l) => l.investmentCategory === "Short Term"
        );
      case "long-term":
        // Long term: Projects
        return opportunities.filter(
          (l) => l.investmentCategory === "Long Term"
        );
      case "almost-funded":
        return [...opportunities].sort(
          (a, b) => b.fundingProgress - a.fundingProgress
        );
      case "all":
      default:
  ...
  const filters: { id: FilterType; label: string }[] = [
    ...
    { id: "short-term", label: "Short Term Investments" },
    { id: "long-term", label: "Long Term Investments" },
    ...
    <div className="bg-light-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-32">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-bold text-text-dark tracking-tight">
            Investment Opportunities
          </h1>
          <p className="mt-4 text-lg max-w-3xl mx-auto text-slate-gray">
            Browse verified Properties projects across Uganda and start building
            your wealth through fractional ownership.
          </p>
        </div>
