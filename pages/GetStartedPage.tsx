    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-5xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] m-4 border border-gray-100 dark:border-gray-700">
        <div className="md:w-1/2 bg-primary-navy relative overflow-hidden flex flex-col justify-between p-10 text-white">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-bold leading-tight mb-4">
              {isSignUp
                ? "Join the Future of Land Investment"
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-4">
                ...
                <img
                  ...
                  alt="Investor"
                />
                <div className="flex items-center justify-center w-10 h-10 text-xs font-medium text-white bg-gray-700 border-2 border-white rounded-full">
                  +2k
                </div>
              </div>
          ...
          <div className="max-w-md mx-auto w-full">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-1 rounded-lg flex items-center">
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${
                      !isSignUp
                        ? "bg-white dark:bg-gray-600 text-text-dark dark:text-white shadow-sm"
              ...
              <div className="flex gap-2 p-1 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700">
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${
                    loginMethod === "email"
                      ? "bg-white dark:bg-gray-800 text-cta-brown shadow-sm border border-gray-100 dark:border-gray-700"
                      : "text-slate-gray dark:text-gray-400"
                  }`}
                >
                  Email Address
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {isSignUp && (
                <div className="animate-fadeIn">
                  <label className="block text-sm font-medium text-text-dark dark:text-gray-300 mb-1.5">
                    Full Name
                  </label>
              ...
              {loginMethod === "email" ? (
                ...
                <div className="animate-fadeIn">
                  ...
                  <div className="flex gap-2">
                    <div className="flex items-center justify-center px-3 bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm font-bold text-slate-gray dark:text-gray-300">
                      +256
                    </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  <label className="block text-sm font-medium text-text-dark dark:text-gray-300">
                    Password
                  </label>
                  {!isSignUp && (
                    <a
                      href="#"
                      className="text-xs font-medium text-cta-brown hover:underline"
                    >
                      Forgot?
                    </a>
                  )}
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-800 text-slate-gray dark:text-gray-400">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="flex items-center justify-center px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm font-medium text-text-dark dark:text-white">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.1 1.88-2.61 5.79 1.07 7.22-.67 1.72-1.6 3.42-3.12 3.99zm-3.17-15.1c.61-1.24 2.3-1.9 3.06-1.57.25 2.22-2.11 4.54-4.53 4.1-.21-1.32.74-2.53 1.47-2.53z" />
                </svg>
                Apple
              </button>
            </div>
        ...
        <div className="absolute bottom-4 z-10 text-center w-full text-xs text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Asset Cycle Africa. All rights
          reserved.{" "}
          <a href="#" className="hover:text-cta-brown ml-2 underline">
            Privacy Policy
          </a>
        </div>
      </div>
