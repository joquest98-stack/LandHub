        ...
        >
            ...
            <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
                ...
                <p className="mt-4 md:mt-6 text-base sm:text-lg md:text-xl max-w-2xl mx-auto text-slate-gray dark:text-gray-300">
                    Have questions about investing or listing properties? We're here to help you every step of the way.
                </p>
            </div>
        </section>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    <div className="space-y-8 order-2 lg:order-1">
                        <div>
                            <h2 className="text-2xl md:text-3xl font-bold text-text-dark dark:text-white mb-4">Contact Information</h2>
                            <p className="text-slate-gray dark:text-gray-400 text-base md:text-lg leading-relaxed">
                                Fill out the form or reach out to us directly via phone or email.
                            </p>
                        </div>
                        ...
                        <div className="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm lg:bg-transparent lg:shadow-none lg:border-0 lg:p-0">
                            <div className="flex items-start space-x-4">
                                <div className="flex-shrink-0 bg-cta-brown/10 dark:bg-cta-brown/20 p-3 rounded-lg">
                                    <svg className="w-6 h-6 text-cta-brown" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold text-text-dark dark:text-white">Phone</h3>
                                    <p className="text-slate-gray dark:text-gray-400 mt-1 text-sm sm:text-base">+256 700 123 456<br/>+256 772 987 654</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-text-dark dark:text-white">Email</h3>
                                    <p className="text-slate-gray dark:text-gray-400 mt-1 text-sm sm:text-base break-all">support@assetcycleafrica.com<br/>info@assetcycleafrica.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="order-1 lg:order-2 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-6 md:p-10 transition-colors duration-300">
                         <h2 className="text-2xl font-bold text-text-dark dark:text-white mb-6">Send us a Message</h2>
                         ...
                         {status === 'success' ? (
                             <div className="flex flex-col items-center justify-center text-center py-12 space-y-4 animate-fadeIn">
                                 ...
                                 <h3 className="text-xl font-bold text-text-dark dark:text-white">Message Sent!</h3>
                                 <p className="text-slate-gray dark:text-gray-400">Thank you for contacting us. We will get back to you shortly.</p>
                                 <Button variant="outline" onClick={() => setStatus('idle')} className="mt-4 dark:border-gray-600 dark:text-white dark:hover:bg-gray-700">Send Another Message</Button>
                             </div>
                         ) : (
                             <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        <label htmlFor="name" className="block text-sm font-medium text-slate-gray dark:text-gray-400 mb-2">Full Name</label>
                                        <input
                                            type="text"
                                            id="name"
                                            name="name"
                                    ...
                                    <div>
                                        <label htmlFor="email" className="block text-sm font-medium text-slate-gray dark:text-gray-400 mb-2">Email Address</label>
                                        <input
                                            type="email"
                                            id="email"
                                            name="email"
                                ...
                                <div>
                                    <label htmlFor="subject" className="block text-sm font-medium text-slate-gray dark:text-gray-400 mb-2">Subject</label>
                                     <select
                                        id="subject"
                                        name="subject"
                                        required
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-medium text-slate-gray dark:text-gray-400 mb-2">Message</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        required
                                ...
                                <Button 
                                    ...
                                    variant="primary" 
                                    size="lg" 
                                    className={`w-full ${status === 'submitting' ? 'opacity-75 cursor-not-allowed' : ''}`}
