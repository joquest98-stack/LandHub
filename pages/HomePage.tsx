// Import React and the custom Button component.
import React from 'react';
import Button from '../components/ui/Button';

/**
 * The HomePage component, which serves as the main landing page for the application.
 */
            ...
            >
                ...
                <div className="relative z-10 text-center px-4">
                    ...
                    <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto text-slate-gray">
                        Start investing in verified Ugandan land with as little as you can afford. 
                        <br />
