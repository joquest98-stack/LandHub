    ...
    return (
        <div className="border-b border-gray-100 dark:border-gray-700 py-4 last:border-0">
            <button 
                ...
                className="flex items-center justify-between w-full text-left font-semibold text-text-dark dark:text-white hover:text-cta-brown transition-colors mb-2"
            >
                <span>{title}</span>
                <svg 
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors duration-300">
            <div className="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
                <h3 className="font-bold text-text-dark dark:text-white">Filters</h3>
                <button 
            ...
            <div className="p-4">
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full border border-gray-200 dark:border-gray-600 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-cta-brown/20 focus:border-cta-brown outline-none transition-all bg-white dark:bg-gray-900 text-text-dark dark:text-white"
                        />
                ...
                <FilterSection title="Price Range">
                    <input
                        ...
                        className="w-full h-1.5 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer accent-cta-brown"
                    />
                    <div className="flex justify-between text-xs text-slate-gray dark:text-gray-400 mt-2 font-medium">
                            ...
                            <label key={type} className="flex items-center cursor-pointer group">
                                <div className="relative flex items-center">
                                    <input
                                        ...
                                        className="peer h-4 w-4 text-cta-brown border-gray-300 dark:border-gray-600 rounded focus:ring-cta-brown transition duration-150 ease-in-out cursor-pointer bg-white dark:bg-gray-900"
                                    />
                                </div>
                                <span className="ml-2 text-sm text-slate-gray dark:text-gray-400 group-hover:text-text-dark dark:group-hover:text-white transition-colors">{type}</span>
                            </label>
                        ))}
                    </div>
                </FilterSection>
