...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  const legalLinks = [
    { name: "Terms of Service", page: Page.TERMS },
    { name: "Privacy Policy", page: Page.PRIVACY },
    { name: "Investment Disclaimer", page: Page.DISCLAIMER },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-bold">Asset Cycle Africa</h2>
            <p className="mt-2 text-gray-400">
              Own Properties, One Step at a Time.
            </p>
          </div>
              ...
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <button
                    ...
                    className="text-base text-gray-300 hover:text-white focus:outline-none hover:underline text-left"
                  >
                    {link.name}
                  </button>
                </li>
            ...
            <div className="mt-4 flex space-x-4">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M16 11.37A4 4 0 1 1 11.37 7 4 4 0 0 1 16 11.37z"
                    strokeWidth="2"
                    fill="none"
                  />
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Asset Cycle Africa Platform. All
            rights reserved.
          </p>
        </div>
      </div>
