 ...
 * @param {React.ReactNode} props.icon - The icon for the feature.
...
/**
 * A section component that explains why users should choose the LandHub platform.
 * It displays a grid of features.
 */
