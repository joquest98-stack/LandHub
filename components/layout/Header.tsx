        ...
        <div className="flex items-center justify-between h-16 px-6">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-full text-text-dark hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-text-dark"
            >
